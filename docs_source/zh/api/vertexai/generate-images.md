...
### config `GenerateImagesConfig` <font color="gray">可选</font>

图片生成配置对象，包含以下字段：

#### number_of_images `integer` <font color="gray">可选</font>
...
#### negative_prompt `string` <font color="gray">可选</font>
...
#### aspect_ratio `string` <font color="gray">可选</font>
...
#### output_mime_type `string` <font color="gray">可选</font>
...
#### output_compression_quality `integer` <font color="gray">可选</font>
...
#### enhance_prompt `boolean` <font color="gray">可选</font>
...
#### person_generation `string` <font color="gray">可选</font>
...
#### safety_filter_level `string` <font color="gray">可选</font>
...
#### include_rai_reason `boolean` <font color="gray">可选</font>
...
#### add_watermark `boolean` <font color="gray">可选</font>
...
#### guidance_scale `number` <font color="gray">可选</font>
...
#### http_options.extra_body.imageSize `string` <font color="gray">可选</font>
...
#### http_options.extra_body.quality `string` <font color="gray">可选</font>
...
#### http_options.extra_body.sampleImageSize `string` <font color="gray">可选</font>
...
### reference_images `array` <font color="FA6062">必选</font>

参考图片列表，包含原图和蒙版（可选）。不同供应商对参考图片数量有限制：可灵（Kling）最多 1 张，Flux 最多 8 张。

::: details RawReferenceImage（原图）

- `reference_id` `integer` <font color="FA6062">必选</font>：参考图片的标识 ID。
- `reference_image` `Image` <font color="FA6062">必选</font>：图片对象。
...
- `reference_id` `integer` <font color="FA6062">必选</font>：蒙版的标识 ID。
- `reference_image` `Image` <font color="FA6062">必选</font>：蒙版图片对象，透明区域为编辑区域。
  - `image_bytes` `bytes`：蒙版的二进制数据。
  - `mime_type` `string`：图片 MIME 类型。
- `config` `MaskReferenceConfig` <font color="FA6062">必选</font>：蒙版配置。
  - `mask_mode` `string`：蒙版模式，设置为 `MASK_MODE_USER_PROVIDED`。

:::

### config `EditImageConfig` <font color="gray">可选</font>
