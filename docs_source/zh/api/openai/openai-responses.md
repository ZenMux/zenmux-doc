...
- type `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`input_text`
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`message`
- role `string`<span style="color: #FA6062; font-weight: 400">\*</span>：固定为 `assistant`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：output message 的唯一 ID
- status `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`in_progress` / `completed` / `incomplete`
- content `array`<span style="color: #FA6062; font-weight: 400">\*</span>：**Output content parts** 列表（见下）

###### Output content parts（输出内容分片）可能类型

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`output_text`
- text `string`<span style="color: #FA6062; font-weight: 400">\*</span>：输出文本
- annotations `array`<span style="color: #FA6062; font-weight: 400">\*</span>：标注（见下）
- logprobs `array`<span style="color: #FA6062; font-weight: 400">\*</span>：logprobs（见下）

**annotations** 元素可能类型：

- File citation `object`
  - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`file_citation`
  - file_id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：引用文件的 ID
  - filename `string`<span style="color: #FA6062; font-weight: 400">\*</span>：引用文件的名称
  - index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：在文本中的起始索引位置
- URL citation `object`
  - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`url_citation`
  - start_index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：引用在文本中的起始索引位置
  - end_index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：引用在文本中的结束索引位置
  - title `string`<span style="color: #FA6062; font-weight: 400">\*</span>：引用网页的标题
  - url `string`<span style="color: #FA6062; font-weight: 400">\*</span>：引用网页的 URL 地址
- Container file citation `object`
  - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`container_file_citation`
  - container_id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：容器文件的 ID
  - file_id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：实际引用文件的 ID
  - filename `string`<span style="color: #FA6062; font-weight: 400">\*</span>：引用文件的名称
  - start_index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：引用在文本中的起始索引位置
  - end_index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：引用在文本中的结束索引位置
- File path `object`
  - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`file_path`
  - file_id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：文件的 ID
  - index `integer`<span style="color: #FA6062; font-weight: 400">\*</span>：文件在列表中的索引位置

**logprobs**（每个元素为一个 token 的 logprob 信息，字段层级如下）：

- bytes `array`<span style="color: #FA6062; font-weight: 400">\*</span>：token 的字节表示
- logprob `number`<span style="color: #FA6062; font-weight: 400">\*</span>：token 的对数概率值
- token `string`<span style="color: #FA6062; font-weight: 400">\*</span>：token 的文本内容
- top_logprobs `array`<span style="color: #FA6062; font-weight: 400">\*</span>：最可能的候选 token 列表（每个元素含 `bytes` / `logprob` / `token`）

2. Refusal `object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`refusal`
- refusal `string`<span style="color: #FA6062; font-weight: 400">\*</span>：模型拒绝回答的原因说明
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`web_search_call`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：web search tool call 的唯一 ID
- status `string`<span style="color: #FA6062; font-weight: 400">\*</span>
- action `object`<span style="color: #FA6062; font-weight: 400">\*</span>：描述本次 web 工具“具体做了什么动作”（search/open_page/find）
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`open_page`
- url `string`<span style="color: #FA6062; font-weight: 400">\*</span>：要打开的网页 URL

3. Find action `object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`find`
- url `string`<span style="color: #FA6062; font-weight: 400">\*</span>：要搜索的页面 URL
- pattern `string`<span style="color: #FA6062; font-weight: 400">\*</span>：搜索模式或关键词

:::

<!-- :::details File search tool call（文件搜索工具调用）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`file_search_call`
...
- type `string`：`double_click` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`double_click`
- x `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：双击位置的 X 坐标（像素）
- y `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：双击位置的 Y 坐标（像素）

###### Move（移动鼠标）`object`

- type `string`：`move` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`move`
- x `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：目标位置的 X 坐标（像素）
- y `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：目标位置的 Y 坐标（像素）

###### Screenshot `object`

- type `screenshot`：`screenshot` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`screenshot`

###### Drag（拖拽）`object`

- type `string`：`drag` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`drag`
- path `array` <span style="color: #FA6062; font-weight: 400">\*</span>：拖拽路径的坐标点列表
  - x `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：路径点的 X 坐标（像素）
  - y `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：路径点的 Y 坐标（像素）
...
- type `string`：`type` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`type`
- text `string` <span style="color: #FA6062; font-weight: 400">\*</span>：要输入的文本内容

###### Keypress（按键/组合键）`object`

- type `string`：`keypress` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`keypress`
- keys `array` <span style="color: #FA6062; font-weight: 400">\*</span>：要按下的按键组合，如 `["CTRL","L"]` 表示 Ctrl+L

###### Wait（等待）`object`

- type `string`：`wait` <span style="color: #FA6062; font-weight: 400">\*</span>：动作类型，固定为`wait`

:::

:::details Computer tool call output（Computer Use 输出回传）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`computer_call_output`
...
- type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`code_interpreter_call`
- id `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：代码解释器调用的唯一 ID
- container_id `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：代码运行的容器环境 ID
- code `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：要执行的代码内容（可能为 null）
- outputs `array`<span style="color: #FA6062; font-weight: 400">&#42;</span>：代码执行的输出结果列表（可能为 null）
  - Logs `object`
    - type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`logs`
    - logs `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：代码执行产生的日志输出
  - Image `object`
    - type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`image`
    - url `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：生成的图片 URL 地址
- status `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：调用状态，`in_progress` / `completed` / `incomplete` / `interpreting` / `failed`

::: -->

<!-- :::details Image generation call（图片生成调用）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`image_generation_call`
- id `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：图片生成调用的唯一 ID
- result `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：生成的图片数据（base64 编码格式）
- status `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：调用状态，如`in_progress` / `completed` / `failed`

::: -->

:::details Local shell call（本地 shell 调用）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`local_shell_call`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：本地 shell 调用的唯一 ID
- call_id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：调用的关联 ID
- status `string`<span style="color: #FA6062; font-weight: 400">\*</span>：调用状态，如`in_progress` / `completed` / `failed`
- action `object`<span style="color: #FA6062; font-weight: 400">\*</span>：具体的 shell 执行动作
...
- output `array`<span style="color: #FA6062; font-weight: 400">\*</span>：命令执行的输出块列表，每个元素包含：
  ...
  - outcome `object`<span style="color: #FA6062; font-weight: 400">\*</span>：命令执行结果状态（联合类型）
    - Timeout outcome `object`
      - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`timeout`：命令执行超时
    - Exit outcome `object`
      - type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`exit`：命令正常退出
      - exit_code `integer`<span style="color: #FA6062; font-weight: 400">\*</span>
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`create_file`
- path `string`<span style="color: #FA6062; font-weight: 400">\*</span>：相对于工作区根目录的文件路径
- diff `string`<span style="color: #FA6062; font-weight: 400">\*</span>：统一格式的 diff 补丁内容

2. Delete file `object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`delete_file`
- path `string`<span style="color: #FA6062; font-weight: 400">\*</span>：要删除的文件路径

3. Update file `object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`update_file`
- path `string`<span style="color: #FA6062; font-weight: 400">\*</span>：要更新的文件路径
- diff `string`<span style="color: #FA6062; font-weight: 400">\*</span>：统一格式的 diff 补丁内容
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`mcp_approval_request`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：审批请求的唯一标识符 ID
- server_label `string`<span style="color: #FA6062; font-weight: 400">\*</span>：MCP 服务器的标签名称
- name `string`<span style="color: #FA6062; font-weight: 400">\*</span>：请求运行的工具名称
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`mcp_call`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：MCP 工具调用的唯一标识符
- server_label `string`<span style="color: #FA6062; font-weight: 400">\*</span>：MCP 服务器的标签名称
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`reasoning`
- id `string`<span style="color: #FA6062; font-weight: 400">\*</span>：推理内容的唯一标识符 ID
- summary `array`<span style="color: #FA6062; font-weight: 400">\*</span>：推理摘要内容列表
  - Summary text `object`
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`function`：工具类型，固定为函数工具
...
- filters `object` <span style="color: #666; font-weight: 400; font-size: 14px">可选</span>：搜索结果的过滤条件
  - Comparison Filter `object`：比较过滤器
    ...
    - value `string | number | boolean | array`<span style="color: #FA6062; font-weight: 400">&#42;</span>：要比较的值
...
- type `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`computer_use_preview`
- display_width `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：显示区域宽度（像素）
- display_height `integer` <span style="color: #FA6062; font-weight: 400">\*</span>：显示区域高度（像素）
- environment `string` <span style="color: #FA6062; font-weight: 400">\*</span>：环境类型（如 `browser` / `mac` / `windows` / `ubuntu`）

:::

<!-- :::details Code interpreter（代码解释器）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">&#42;</span>：`code_interpreter`
- container `string | object`<span style="color: #FA6062; font-weight: 400">&#42;</span>：代码执行容器配置
  - `string`：现有容器的 ID
  - `object`：新容器的配置对象
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`apply_patch`
...
- type `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`shell`
...
- type `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`local_shell`
...
- format `object` <span style="color: #666; font-weight: 400; font-size: 14px">可选</span>：输入格式（默认是自由文本）
  ...
  - **Grammar format** `object`
    - type `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`grammar`
    - syntax `string` <span style="color: #FA6062; font-weight: 400">\*</span>：`lark` / `regex`
    - definition `string` <span style="color: #FA6062; font-weight: 400">\*</span>：语法定义
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`allowed_tools`
- mode `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`auto` / `required`
- tools `array`<span style="color: #FA6062; font-weight: 400">\*</span>：允许的工具集合（示例：`{ "type":"function","name":"get_weather" }` 等

:::

:::details Hosted tool（强制使用某个内置工具）`object`

- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：以下之一
  <!-- `file_search`  -->
...
- type `string`<span style="color: #FA6062; font-weight: 400">\*</span>：`function`
