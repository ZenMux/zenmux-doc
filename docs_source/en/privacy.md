...
**Model Usage Records.** When you use AI models through our services, we maintain records of your interactions, which include the specific model used, the date and time of the interaction, and the number of tokens consumed. We do not retain the full content of your inputs or outputs as part of such records; where related content is retained for service continuity, it is handled in accordance with the applicable terms for User Content. These records are available for access through our website within 180 days following the date of the relevant interaction.

## II. How We Store and Protect Personal Information

1. We will store and/or transfer your personal information in accordance with applicable laws and regulations. Personal information collected and generated by us about you may be transferred and/or stored outside your country/region of residence. Generally, all data (including Personal Information and User Content) uploaded or transferred by you to us related to your account and product services will be stored in Singapore. In addition, to improve regional service performance and strengthen our disaster recovery capabilities, certain information may also be stored or processed in Malaysia. In carrying out such international transfers, we will follow the requirements of applicable laws and regulations, and will require such overseas recipients or sub-processors of your personal information to ensure that the standard of protection provided by such overseas recipients of personal information is comparable to that under applicable laws and regulations of your country/region of residence.
...
We may engage carefully selected third-party service providers, including cloud service providers in Singapore and Malaysia, to process personal information on our behalf. These providers act only on our instructions and are contractually bound to maintain appropriate security and confidentiality measures in accordance with applicable data protection laws.
...
**Email address: [support@zenmux.ai](mailto:support@zenmux.ai)**
...
1. For the purpose of this Policy, "ZenMux" or "we", "our" "us" means NexaMind Singapore Pte. Ltd., the operator of the ZenMux's products and services, which is a company incorporated under the laws of Singapore, with its registered place at 11 COLLYER QUAY, #05-06C, THE ARCADE, SINGAPORE 049317.
