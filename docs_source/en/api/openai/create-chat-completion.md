...
- content `string or array` <span style="color: #FA6062; font-weight: 400">\*</span>
  ...
  - Array of content parts `array` <span style="color: #FA6062; font-weight: 400">\*</span>
    ...
    , an image URL or a base64 Data URL - detail `string` <span style="color: #666; font-weight: 400">Optional</span>, typical values: `low` / `high` / `auto`, used to control image parsing fidelity
    ...
    , always `file` - file `object` <span style="color: #FA6062; font-weight: 400">\*</span>
            ...
            - file_data `string` <span style="color: #666; font-weight: 400">Optional</span>
              - Base64-encoded file data, for sending file content directly in the request body
            - filename `string` <span style="color: #666; font-weight: 400">Optional</span>
...
- reasoning_details `array` Optional (**required for multi-turn tool-calling scenarios**)
  ...
  - index `number` <span style="color: #666; font-weight: 400">Optional</span>
...
### max_completion_tokens `integer or null` <span style="color: #666; font-weight: 400">Optional</span>
...
### n `integer or null` <span style="color: #666; font-weight: 400">Optional</span>

Number of candidate responses to return. Currently only `n=1` is supported.

### frequency_penalty `number or null` <span style="color: #666; font-weight: 400">Optional</span>
...
### presence_penalty `number or null` <span style="color: #666; font-weight: 400">Optional</span>
...
### stop `string | array | null` <span style="color: #666; font-weight: 400">Optional</span>
...
### logit_bias `object` <span style="color: #666; font-weight: 400">Optional</span>
...
### logprobs `boolean or null` <span style="color: #666; font-weight: 400">Optional</span>
...
### tool_choice `string or object` <span style="color: #666; font-weight: 400">Optional</span>
...
### parallel_tool_calls `boolean` <span style="color: #666; font-weight: 400">Optional</span>

- Default: `true`

Whether to allow the model to call multiple tools (functions) **in parallel** within a single response.

### reasoning_effort `string` <span style="color: #666; font-weight: 400">Optional</span> (reasoning models)
...
### verbosity `string` <span style="color: #666; font-weight: 400">Optional</span>

- Default: `"medium"`

Constrains output verbosity: `low` (concise), `medium` (balanced), `high` (more detailed).

### web_search_options `object` <span style="color: #666; font-weight: 400">Optional</span>
...
### stream `boolean or null` <span style="color: #666; font-weight: 400">Optional</span>
...
#### effort `string` <span style="color: #666; font-weight: 400">Optional</span>
...
#### max_tokens `number` <span style="color: #666; font-weight: 400">Optional</span>

Maximum token limit for the reasoning process (not the final answer).

#### exclude `boolean` <span style="color: #666; font-weight: 400">Optional</span>
...
- json_schema `object` <span style="color: #FA6062; font-weight: 400">\*</span>
  ...
  - schema `object` <span style="color: #666; font-weight: 400">Optional</span>
    The schema for the response format, described as a JSON Schema object.
  - strict `boolean` <span style="color: #666; font-weight: 400">Optional</span>
