...
1.2 "Our Service" / "ZenMux": Refers to Our Service we provide via the ZenMux website（https://zenmux.ai/), which curates and offers access to multiple top-tier algorithm models for users.
...
- **Pay-as-you-go Fee Refund Amount = fees corresponding to the Unused Paid PAYG Credits × (1 − 5%)，in which，Unused Paid PAYG Credits = the total PAYG credits you paid for – the PAYG credits you have used**
- **Subscription Fee Refund Amount = (Subscription Fee − Consumption Fee ) × (1 − 5%)**

  **9.3 Refund Application:** Please send your refund application to support@zenmux.ai, and provide your **account email / account ID, purchase/subscription starting date and time (YYYY−MM−DDHH), purchase/subscription fee amount, current unused credits balance, reason for refund request** and any other information We may require from time to time.
