        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              link: "/api/platform/statistics-model-usage",
            },
            {
              text: "Get Statistics Trending",
              link: "/api/platform/statistics-trending",
            },
            {
              text: "Get Statistics Performance",
              link: "/api/platform/statistics-performance",
            },
            {
              text: "Get App Trending",
              link: "/api/platform/statistics-app-trending",
            },
            {
              text: "Get App Leaderboard",
              link: "/api/platform/statistics-app-leaderboard",
            },
          ],
        },
      ],
      "/best-practices/": [
        {
          ...
          items: [
            ...
            {
              text: '<img src="https://cdn.marmot-cloud.com/storage/zenmux/2026/08/17/2aZy1tH/Namepi-TypeColor.svg" />Pi Coding Agent Integration',
