    ...
    endpoints: [
      {
        ...
        iconType: "chat",
        docUrl: "/api/openai/create-chat-completion.html",
      },
      {
        title: "Responses",
        path: "/responses",
        iconType: "chat",
        docUrl: "/api/openai/openai-responses.html",
      },
      {
        title: "List Models",
        path: "/models",
        iconType: "models",
        docUrl: "/api/openai/openai-list-models.html",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        path: "/v1/messages",
        iconType: "chat",
        docUrl: "/api/anthropic/create-messages.html",
      },
      {
        title: "List Models",
        path: "/v1/models",
        iconType: "models",
        docUrl: "/api/anthropic/anthropic-list-models.html",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        iconType: "generate",
        docUrl: "/api/vertexai/generate-content.html",
      },
      {
      ...
      },
      {
        ...
        path: "/v1beta/models",
        iconType: "models",
        docUrl: "/api/vertexai/google-list-models.html",
      },
    ],
  },
];
